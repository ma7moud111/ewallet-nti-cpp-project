...
void Localizer::initializeTranslations() {
    ...
    translations["transfer_option"] = {
        {Settings::Language::English, "(4) Transfer Money"},
        {Settings::Language::Deutsch, "(4) Geld überweisen"}
    };
    
    translations["pay_bills"] = {
        {Settings::Language::English, "(5) Pay Bills"},
        {Settings::Language::Deutsch, "(5) Rechnungen bezahlen"}
    };
    ...
    // Transfer Menu
    translations["enter_recipient"] = {
        {Settings::Language::English, "Enter recipient username: "},
        {Settings::Language::Deutsch, "Empfänger-Benutzername eingeben: "}
    };
    
    translations["enter_transfer_amount"] = {
        {Settings::Language::English, "Enter amount to transfer: "},
        {Settings::Language::Deutsch, "Zu überweisenden Betrag eingeben: "}
    };
    
    translations["transfer_success"] = {
        {Settings::Language::English, "Transfer completed successfully!"},
        {Settings::Language::Deutsch, "Überweisung erfolgreich abgeschlossen!"}
    };
    
    translations["transfer_failed"] = {
        {Settings::Language::English, "Transfer failed!"},
        {Settings::Language::Deutsch, "Überweisung fehlgeschlagen!"}
    };
